import { Address, Ansprechpartner, BillingData, Institution, Umsatzsteuer, Versicherter } from "./types"
import { 
    arrayConstraints, valueConstraints,
    isArray, isChar, isVarchar, isDate, isIK, isInt, isRechnungsnummer, isRequired,
    isOptionalChar, isOptionalDate, isOptionalInt, isOptionalVarchar,
    error, isTruncatedIfTooLong,
} from "./validation/utils"

export const constraintsBillingData = (b: BillingData) => [
    isRequired(b, "datenaustauschreferenzJeEmpfaengerIK"),
    ...valueConstraints(b, "datenaustauschreferenzJeEmpfaengerIK", constraintsIKToDatenaustauschreferenz),
    isRequired(b, "testIndicator"),
    isRequired(b, "rechnungsart"),
    isRechnungsnummer(b, "rechnungsnummerprefix"),
    isOptionalDate(b, "rechnungsdatum"),
    isDate(b, "abrechnungsmonat"),
    isOptionalInt(b, "korrekturlieferung", 0, 10),
    ...valueConstraints(b, "abrechnungsstelle", constraintsInstitution),
    isRequired(b, "laufendeDatenannahmeImJahrJeEmpfaengerIK"), 
    ...valueConstraints(b, "laufendeDatenannahmeImJahrJeEmpfaengerIK", constraintsIKToLfdDatenannahmeimJahr),
]
