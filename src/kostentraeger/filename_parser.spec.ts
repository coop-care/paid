import parse from "./filename_parser"
...
describe("filename parser", () => {
    ...
    it("parses filename", () => {
        ...
        expect(parse("AO06Q221.ke1")).toEqual({
            kassenart: "Allgemeine Ortskrankenkassen",
            verfahren: "Datenaustausch Teilprojekt Leistungserbringer Pflege",
            validityStartDate: new Date(2021, 3),
            einsatzgebiet: "Kostenträgerdatei Datenaustausch",
            fileFormat: "EDIFACT",
            version: 1
        })
    })
